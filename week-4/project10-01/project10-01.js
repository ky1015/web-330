...
// For loop that iterates through every item in the pieces node list and adds an event listener that runs the grabPiece function in response to a pointerdown event
